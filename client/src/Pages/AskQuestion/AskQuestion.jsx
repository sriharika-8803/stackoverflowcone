...
const handleEnter = (e) =>{
    //here key is nothing but keyboard pressed key whether it may h if user press h
    if(e.key === 'Enter'){
            ...
            <form onSubmit={handleSubmit}>
                <div className="ask-form-container">
                    ...
                    <label htmlFor="ask-ques-body">
                        <h4>Body</h4>
                        <p>Include the all the information someone would need to answer your question</p>
